...
//volatile uint8_t wakeupPin= 3;   // RTC provides a 1Hz interrupt signal on this pin // pin for node 2
          ...
          if(radio.isAckPayloadAvailable())
            {
              ...
              Serial.println("ack buffer cleared");
              //enterSleep();
            }else{
               Serial.print("no acknowledgement"); 
               //enterSleep();
              }
